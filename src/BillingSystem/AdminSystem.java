...
public class AdminSystem extends JFrame {
	...
	public AdminSystem() {
		...
		Product3.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 11));
		Product3.setBounds(46, 93, 80, 25);
		...
		textProduct1.setEditable(false);
		...
		textProduct2.setEditable(false);
		...
		textProduct3.setEditable(false);
		...
		textProduct4.setEditable(false);
		...
		textProduct5.setEditable(false);
		...
		Item2.setFont(new Font("Tahoma", Font.BOLD, 20));
		Item2.setBounds(292, 57, 119, 25);
		panel_1.add(Item2);
		
		Item3 = new JLabel("ORANGE JUICE");
		Item3.setForeground(Color.WHITE);
		Item3.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 10));
		Item3.setBounds(313, 93, 80, 25);
		panel_1.add(Item3);
		...
		Item4.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 13));
		Item4.setBounds(302, 132, 88, 25);
		panel_1.add(Item4);
		...
		Item5.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 12));
		Item5.setBounds(292, 168, 104, 25);
		panel_1.add(Item5);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Product1.setText(JOptionPane.showInputDialog(null, "Enter new name", "Edit", JOptionPane.INFORMATION_MESSAGE));
				parent.rProduct1 = Double.parseDouble(JOptionPane.showInputDialog(null, "Enter new price", "Edit", JOptionPane.INFORMATION_MESSAGE));
			}
		});
		btnNewButton_1.setBounds(25, 29, 19, 13);
		panel_1.add(btnNewButton_1);
		
		JButton button = new JButton("New button");
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Product2.setText(JOptionPane.showInputDialog(null, "Enter new name", "Edit", JOptionPane.INFORMATION_MESSAGE));
				parent.rProduct2 = Double.parseDouble(JOptionPane.showInputDialog(null, "Enter new price", "Edit", JOptionPane.INFORMATION_MESSAGE));
			}
		});
		button.setBounds(25, 60, 19, 13);
		panel_1.add(button);
		
		JButton button_1 = new JButton("New button");
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Product3.setText(JOptionPane.showInputDialog(null, "Enter new name", "Edit", JOptionPane.INFORMATION_MESSAGE));
				parent.rProduct3 = Double.parseDouble(JOptionPane.showInputDialog(null, "Enter new price", "Edit", JOptionPane.INFORMATION_MESSAGE));
			}
		});
		button_1.setBounds(25, 96, 19, 13);
		panel_1.add(button_1);
		
		JButton button_2 = new JButton("New button");
		button_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Product4.setText(JOptionPane.showInputDialog(null, "Enter new name", "Edit", JOptionPane.INFORMATION_MESSAGE));
				parent.rProduct4 = Double.parseDouble(JOptionPane.showInputDialog(null, "Enter new price", "Edit", JOptionPane.INFORMATION_MESSAGE));
			}
		});
		button_2.setBounds(25, 135, 19, 13);
		panel_1.add(button_2);
		
		JButton button_3 = new JButton("New button");
		button_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Product5.setText(JOptionPane.showInputDialog(null, "Enter new name", "Edit", JOptionPane.INFORMATION_MESSAGE));
				parent.rProduct5 = Double.parseDouble(JOptionPane.showInputDialog(null, "Enter new price", "Edit", JOptionPane.INFORMATION_MESSAGE));
			}
		});
		button_3.setBounds(25, 168, 19, 13);
		panel_1.add(button_3);
		
		JButton button_4 = new JButton("New button");
		button_4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Item1.setText(JOptionPane.showInputDialog(null, "Enter new name", "Edit", JOptionPane.INFORMATION_MESSAGE));
				parent.rItem1 = Double.parseDouble(JOptionPane.showInputDialog(null, "Enter new price", "Edit", JOptionPane.INFORMATION_MESSAGE));
			}
		});
		button_4.setBounds(287, 24, 19, 13);
		panel_1.add(button_4);
		
		JButton button_5 = new JButton("New button");
		button_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Item2.setText(JOptionPane.showInputDialog(null, "Enter new name", "Edit", JOptionPane.INFORMATION_MESSAGE));
				parent.rItem2 = Double.parseDouble(JOptionPane.showInputDialog(null, "Enter new price", "Edit", JOptionPane.INFORMATION_MESSAGE));
			}
		});
		button_5.setBounds(287, 60, 19, 13);
		panel_1.add(button_5);
		
		JButton button_6 = new JButton("New button");
		button_6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Item3.setText(JOptionPane.showInputDialog(null, "Enter new name", "Edit", JOptionPane.INFORMATION_MESSAGE));
				parent.rItem3 = Double.parseDouble(JOptionPane.showInputDialog(null, "Enter new price", "Edit", JOptionPane.INFORMATION_MESSAGE));
			}
		});
		button_6.setBounds(287, 96, 19, 13);
		panel_1.add(button_6);
		
		JButton button_7 = new JButton("New button");
		button_7.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Item4.setText(JOptionPane.showInputDialog(null, "Enter new name", "Edit", JOptionPane.INFORMATION_MESSAGE));
				parent.rItem4 = Double.parseDouble(JOptionPane.showInputDialog(null, "Enter new price", "Edit", JOptionPane.INFORMATION_MESSAGE));
			}
		});
		button_7.setBounds(287, 135, 19, 13);
		panel_1.add(button_7);
		
		JButton button_8 = new JButton("New button");
		button_8.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Item5.setText(JOptionPane.showInputDialog(null, "Enter new name", "Edit", JOptionPane.INFORMATION_MESSAGE));
				parent.rItem5 = Double.parseDouble(JOptionPane.showInputDialog(null, "Enter new price", "Edit", JOptionPane.INFORMATION_MESSAGE));
			}
		});
		button_8.setBounds(287, 171, 19, 13);
	...
	public void saveName() {
		try {
			...
			p.write(Product1.getText()+":"+Product2.getText()+":"+Product3.getText()+":"+Product4.getText()+":"+Product5.getText()+":"+Item1.getText()+":"+Item2.getText()+":"+Item3.getText()+":"+Item4.getText()+":"+Item5.getText()+":");
			p.close();
		} catch (IOException e) {
			e.printStackTrace();
		}
